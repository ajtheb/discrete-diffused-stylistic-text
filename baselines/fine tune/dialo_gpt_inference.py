...
model_path = "/home/aswini/Forth_project_on_Person_inspired_CS/baselines/fine tune/results_dialo_gpt2/checkpoint-7500"  # Path to your fine-tuned model

if not os.path.exists(model_path):
    raise ValueError(f"The checkpoint path {model_path} does not exist.")
tokenizer_path = "/home/models/DialoGPT-large"
...
test_df.to_csv("/home/aswini/Forth_project_on_Person_inspired_CS/baselines/inference_scripts/results/finetune/dialo_gpt2.csv",index=False)
