...
coarl_model_path= '/home/aswini/Forth_project_on_Person_inspired_CS/baselines/fine tune/coarl_fine_tuned/checkpoint-5500'
model_id = '/home/models/google-flan-t5-xl'
tokenizer = AutoTokenizer.from_pretrained(model_id)
model = AutoModelForSeq2SeqLM.from_pretrained(coarl_model_path, device_map="auto")
...
res.to_csv(f"/home/aswini/Forth_project_on_Person_inspired_CS/baselines/inference_scripts/results/finetune/coarl_5500.csv",index=False)
