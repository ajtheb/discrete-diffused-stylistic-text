...
def construct_prompt(hatespeech, style, prompt_type="zero-shot", examples=None):
    ...
    base_prompt = f"You are {leader}. Generate a counterspeech response to the following hate speech, rooted in nonviolence, truth, peace, and understanding of {leader}.\ 
